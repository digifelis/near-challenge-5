...
export class Project {
  ...
  constructor(name: string, address: string, funds: u128, description: string, photo:string) {
  ...
  static createProject(address: string, name: string, funds: string, description: string,photo:string): u32 {
    ...
    const newProject = new Project(name, address, funds_u128, description, photo);
